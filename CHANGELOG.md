...
```
1.0.4 --->  + Added empty file in dejo example, because  github not upload it if is empty
            + Added new method get_providers for return kwargs of config, language, etc, only in use for unittest
